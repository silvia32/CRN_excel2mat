...
Step 1: Prepare your Excel Input
Create or place your Excel file inside the excel_data/ folder.
Ensure the file contains a sheet named table_S3 containing the complete list of your chemical reactions.

Step 2: Extract Species (table_S1 Generation)
...
Step 4: Convert SBML to MATLAB (.mat)
